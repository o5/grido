...
class Operation extends Component
{
    ...
    {
        $that = $this;
        $this->grid->onRender[] = function(Grid $grid) use ($operation, $message, $that){
            $grid['form'][Operation::ID][Operation::ID]->controlPrototype->data["grido-$operation"] = $that->translate($message);
        };
